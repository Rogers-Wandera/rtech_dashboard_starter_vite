...
export const updateBodyClass = (choices: any, value: any) => {
  // remove class from choices
  if (choices.length > 0) {
    choices.forEach((other: any) => {
...
export const updateHtmlAttr = (value: any) => {
  // set direction
  setAttr("html", value);
};

export const updateHtmlClass = (choices: any, value: any) => {
  // remove class from choices
  if (choices.length > 0) {
    choices.forEach((other: any) => {
...
export const updateTitle = (value: any) => {
  // set title
  setContent('[data-setting="app_name"]', value);
};

export const updateColorRootVar = (
  theme_scheme: any,
  theme_color: any,
  choices: any
) => {
...
export const updateDomValueBySetting = (setting: any, Choices: any) => {
...
export const updateStorage = (storage: any, key: any, value: any) => {
...
export const updateThemeScheme = (
  value: any,
  Choices: any,
  theme_color: any
) => {
