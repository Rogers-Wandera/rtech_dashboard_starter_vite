        ...
        <AnimatePresence>
          {loading && (
            <div className="tw:absolute tw:inset-0 tw:z-50 tw:backdrop-blur-sm tw:bg-white/80 tw:flex tw:items-center tw:justify-center">
              <CustomLoader
                visible={loading}
                progress={loaderConfigs.progress}
                message={loaderConfigs.message}
                loaderVariant={loaderConfigs.loaderVariant}
                loaderColor={loaderConfigs.loaderColor}
                progressInterval={loaderConfigs.progressInterval}
                progressDuration={loaderConfigs.progressDuration}
                onProgressComplete={loaderConfigs.onProgressComplete}
                showPercentage={loaderConfigs.showPercentage}
              />
            </div>
          )}
        </AnimatePresence>
